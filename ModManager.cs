    ...
    public class UnityModManager
    {
        ...
        public static class Logger
        {
            ...
            public static void Write(string str)
            {
                ...
                try
                {
                    if (mWriter == null && !mIsInit)
                    {
                        mIsInit = true;
                        mWriter = new StreamWriter(LogPath) { AutoFlush = true };
                    }
        ...
        //class ConfigJson<T> where T : ConfigJson<T>, new()
        //{
        //    [NonSerialized]
        //    public string Dir;
        ...
        //            try
        //            {
        //                settings = JsonUtility.FromJson<T>(File.ReadAllText(path));
        //            }
        //            catch (Exception exception)
        //            {
        ...
        //            {
        //                f.SetValue(this, f.GetValue(settings));
        //            }
        //        }
        //    }
        //}
